...
class Line(object):
    ...
    def clone(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        self.clonenumber = self.clonenumber + 1
    ...
    def is_parallel(self, line2):
        ...
        if (self.start.x - self.end.x) != 0:
            if (line2.start.x - line2.end.x)!=0:
                if round((self.start.y - self.end.y) / (self.start.x - self.end.x), 12) == round((line2.start.y - line2.end.y) / (line2.start.x - line2.end.x), 12):
                    return True
                else:
                    return False
                ...
                return False
        elif (line2.start.x - line2.end.x) == 0:
            return True
        else:
            return False
